...
private class Combined2Backdrops(
    ...
    override fun drawBackdrop(
        ...
        backdrop1.drawBackdrop(drawScope, density, coordinates, layerBlock)
        backdrop2.drawBackdrop(drawScope, density, coordinates, layerBlock)
    }
}
...
private class Combined3Backdrops(
    ...
    override fun drawBackdrop(
        ...
        backdrop1.drawBackdrop(drawScope, density, coordinates, layerBlock)
        backdrop2.drawBackdrop(drawScope, density, coordinates, layerBlock)
        backdrop3.drawBackdrop(drawScope, density, coordinates, layerBlock)
    }
}
...
private class CombinedBackdrops(
    ...
    override fun drawBackdrop(
        ...
        backdrops.forEach { backdrop ->
            backdrop.drawBackdrop(drawScope, density, coordinates, layerBlock)
        }
    }
}
