...
export default function AgentLogs() {
  ...
  const staticLogs: LogEntry[] = [
    ...
    },
    {
      ...
      category: "TELEMETRY",
      sector: "Sector F-11",
      message: "Received raw pedestrian throughput array [410, 480, 520, 610] from vision sensor cohort cluster #4.",
      status: "SUCCESS"
    },
    {
      id: "log-3",
  ...
  useEffect(() => {
    ...
    const messages = [
      ...
      "Asymmetric buffer limits updated in the central state-space vector layer model.",
  ...
  return (
    <section id="logs" className="py-20 px-4 sm:px-6 relative bg-[#f7f9fb] border-b border-[#bcc9c6]/40">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-medium tracking-tight text-[#191c1e]">
              ...
              stream <span className="font-serif italic text-[#00685f]">autopilot</span> logs
            </h2>
          ...
          <div className="premium-glass rounded-2xl p-4 border border-white/70 shadow-xs flex items-center gap-3 shrink-0">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-3 py-1.5 bg-neutral-50 rounded-xl border border-neutral-200 text-xs font-semibold text-[#191c1e] w-[200px] sm:w-[240px] focus:outline-none focus:border-[#00685f] transition-all"
              />
            </div>
          </div>
        </div>
