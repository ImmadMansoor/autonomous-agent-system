...
export default function App() {
  const handleAccessTelemetry = () => {
    // Navigate or scroll smoothly to features
    const previewEl = document.getElementById("telemetry");
    if (previewEl) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#f2f4f6] p-3 sm:p-4 font-sans antialiased text-[#191c1e] select-none scroll-smooth">
      {/* Hero Container */}
      <div className="relative w-full h-[calc(100vh-24px)] sm:h-[calc(100vh-32px)] overflow-hidden bg-[#f7f9fb] rounded-2xl sm:rounded-3xl border border-[#bcc9c6] shadow-xs mb-4">
